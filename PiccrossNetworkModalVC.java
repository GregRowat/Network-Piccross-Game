...
public class PiccrossNetworkModalVC extends JDialog
{
    ...
    /** Reference to view so we can reset the connect button if client connection fails */
    private PiccrossView view;
    /** Reference to network client used to connect to network */
    ...
    @param client - reference to the network client in order to call connect and check connection status
    @param view - reference to main view class of program
    **/
    public PiccrossNetworkModalVC(JFrame mainView, PiccrossClient client, PiccrossView view )
    {
    	
    	// set the things. Super description
        ...
        outerPanel.setBorder(BorderFactory.createMatteBorder(5,5,5,5,Color.LIGHT_GRAY));
        ...
        // had to add this line to get the frame to show up
       setVisible(true);
    }
    ...
    private class Controller implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent evt)
        {
            ...
            { 
            	...
            	//set all connection data members to the values entered in network dialogue by user
            	client.setName(getName());
            	client.setAddress(getAddress());
            	client.setPort(getPort());
            	
            	// make thread for timeout
            	Thread connectionThread = new Thread(new Runnable() {

					@Override
					public void run() {
		            	//call connect client to try and establish a connection
		            	client.connectClient(client);
		            	
		            	//if the network connection fails reset the disconnect button
